...
local TuningSection = FishingTab:Section({ Title = "X7 Speed Settings", Opened = true })
...
WindUI:Notify({
    Title = "X22 Speed Berhasil Di Unduh",
    Content = "X22 Speed Berhasil Di Unduh!",
    Duration = 5,
    Icon = "check"
})
